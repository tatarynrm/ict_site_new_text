   ...
   `,
    stages: [
      ...
      },
      {
        ...
        desc: `Менеджери, які працюють в наших офісах, здатні розв’язати будь-які логістичні задачі клієнта. 
            `,
      },
      {
...
Організовуємо перевезення вантажів країнами Західної, Центральної та Східної Європи, Скандинавії та Балтії, транспортуємо товари шляхами Азії, доставляємо до Індії, Китаю та інших віддалених країн. Завдяки нашим партнерам — найбільшим та найнадійнішим автоперевізникам Європи, знаємо як розв’язати найскладнішу логістичну задачу.  
...
`,
  ...
  },
  {
    ...
    info: `
    Досвід перевезень негабаритних та небезпечних вантажів.
...
`,
    stages: [
      ...
      {
        title: `Експертиза`,
        desc: `Експертизу транспортно-експедиційних маршрутів
        `,
      },
      {
        title: `Дозволи`,
      ...
      {
        title: `Супровід`,
        desc: `Супровід та охорона вантажів під час транспортування
  ...
  },
  {
    ...
    ІСТ-Захід — ефективна організація збірних вантажів. Вміємо оптимізувати транспортні ресурси та розумно заощадити на витратах. Створюємо логістичну систему для вчасної доставки ваших речей та вантажів.
    ...
    stages: [
      ...
      {
        title: `Швидкість`,
        desc: `Менеджери відділу збірних залагоджують митні формальності та організовують швидку обробку вантажів
  ...
  },
  {
    ...
    У сучасному світі логістики перевезення контейнерами є ефективним і зручним способом транспортування, що економить час, гроші та забезпечує безпеку і надійність вантажів будь-якого типу. Переваг таких перевезень для бізнесу одразу декілька.

    Перевезення контейнерами — вигідне та ефективне рішення для багатьох бізнесів, які шукають спосіб оптимізувати свою логістику та забезпечити безперебійну поставку вантажів. Зверніться до наших фахівців, щоб отримати додаткову інформацію та поради щодо використання контейнерних перевезень для вашого бізнесу.
    `,
    stages: [
      {
        title: `Гнучкість та масштабованість процесу`,
        desc: `Перевезення контейнерами легко масштабуються відповідно до обсягу вантажів. Ви можете вибирати контейнери різних розмірів і типів залежно від потреб, що забезпечує гнучкість і спрощує логістику вашого бізнесу.
        `,
      },
      {
